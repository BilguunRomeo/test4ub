export const json = {
  title: "ХДХВ-ийн халдвар илрүүлэх шинжилгээ, үйлчилгээнд хамрагдсан ЭБҮ-ийн хийх ярилцлагын асуумж",
      ...
      questions: [
        {
          ...
          isRequired: true,
          choices: ["Тийм （тийм бол 7 дугаар асуулт руу шилжинэ үү)", "Үгүй"]
        }, {
          type: "radiogroup",
          name: "g",
      ...
      questions: [
        {
          ...
          otherText: "Тодорхойлно уу:",
          isRequired: true,
          choices: ["Өртөлтийн өмнөх сэргийлэлт (PrEP)", "Өртөлтийн дараах сэргийлэлт (PEP)", "Авч байгаагүй (авч байгаагүй бол 24 асуултруу шилжинэ үү)"]
        }, {
          type: "checkbox",
          name: "z",
      ...
      questions: [
        {
          ...
          otherText: "Тодорхойлно уу:",
          isRequired: true,
          choices: ["Тийм", "Үгүй (үгүй бол 40-р асуулт руу шилжинэ үү)"]
        },
      ]
    }, {
      title: "ХДХВ-ийн халдвар илрүүлэх шинжилгээ, үйлчилгээнд хамрагдсан ЭБЭ-ийн хийх ярилцлагын асуумж",
      questions: [
        {
          ...
          otherText: "Тодорхойлно уу:",
          isRequired: true,
          choices: ["Тийм, вэб сайтаар", "Тийм, санал хүсэлтийн хайрцгаар", "Үгүй (үгүй бол 43-р асуулт руу шилжинэ үү)"]
        }, {
          type: "radiogroup",
          name: "as",
          ...
          otherText: "Тодорхойлно уу:",
          isRequired: true,
          choices: ["Тийм (тийм бол 45-р асуулт руу шилжинэ үү)", "Үгүй"]
        }, {
          type: "checkbox",
          name: "au",
